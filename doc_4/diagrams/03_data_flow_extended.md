...
>
> 📊 **Graf**: [`03_data_flow_extended.png`](03_data_flow_extended.png)
...
| ADR | Dotyczy |
|---|---|
| [ADR-001](../../Notatki/DECISIONS.md) Repository Pattern | Cała data layer dla cache |
| [ADR-002](../../Notatki/DECISIONS.md) Sync bez clipboard | `SyncToFile` w Flow A, B, C |
| [ADR-004](../../Notatki/DECISIONS.md) Plik tymczasowy `%TEMP%` | Flow B krok 3 + 7 (cleanup) |
| [ADR-005](../../Notatki/DECISIONS.md) Centralizacja routingu | Flow B krok 4 (decision diamond) |
| [ADR-006](../../Notatki/DECISIONS.md) Hard delete pending | Flow C cały — definiuje politykę |
| [ADR-007](../../Notatki/DECISIONS.md) Activate pattern | Flow A, C — `RefreshPendingList` w `UserForm_Activate` |

---

## Cross-reference

- Oryginalny PDF (Flow A + B, bez Flow C): [`../BNC_fazaA_03_data_flow.pdf`](../BNC_fazaA_03_data_flow.pdf)
...
- Model danych: [`04_data_model.png`](04_data_model.png) + [`04_data_model.md`](04_data_model.md)
