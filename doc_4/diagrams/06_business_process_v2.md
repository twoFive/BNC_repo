...
Dokument biznesowy do prezentacji architektury z przełożonym / komitetem decyzyjnym. Workflow w osobnym pliku graficznym (`06_business_process_v2.png`), opis i kontekst poniżej w tekście.
...
📊 **Graf**: [`06_business_process_v2.png`](06_business_process_v2.png)
...
- **Pełna architektura systemu**: [`02_system_architecture.png`](02_system_architecture.png)
- **Architektura modułów**: [`05_module_architecture.png`](05_module_architecture.png)
...
## Zmiany w stosunku do `06_business_process.png` (v1)
