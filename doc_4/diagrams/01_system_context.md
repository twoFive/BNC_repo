...
> **Cel diagramu**: pokazać kto i co styka się z systemem BNC_Sender — aktorów (osoby/zespoły) i systemy zewnętrzne. Widok statyczny, **nie pokazuje** kolejności akcji (do tego służy `06_business_process_v2.png` lub `03_data_flow_extended.png`).
>
> 📊 **Graf**: [`01_system_context.png`](01_system_context.png) (C4 Level 1)
...
- 🖼 [`01_system_context.png`](01_system_context.png) — wizualizacja (C4 Level 1)
...
- 🏗 [`02_system_architecture.png`](02_system_architecture.png) — C4 Level 2 (Container Diagram)
- 🧩 [`05_module_architecture.png`](05_module_architecture.png) — C4 Level 3 (Component Diagram)
- 📐 [`DECISIONS.md`](../DECISIONS.md) — Architectural Decision Records (ADR-001…007)
