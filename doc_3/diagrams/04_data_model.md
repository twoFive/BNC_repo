...
| `EmailBNC` | String (email) | Hardcoded `jessica.cant@swim.omg` ([ADR-003](../DECISIONS.md)) |
| `CacheFolderPath` | String (path) | Hardcoded `C:\BNC_CacheFolder\` ([ADR-003](../DECISIONS.md)) |
...
| ADR | Dotyczy |
|---|---|
| [ADR-001](../DECISIONS.md) Repository Pattern | Encapsulacja dostępu do `ws_*Cache` |
| [ADR-002](../DECISIONS.md) Sync bez clipboard | `SyncToFile` w obu modułach Sync |
| [ADR-003](../DECISIONS.md) Hardcoded EmailBNC + CacheFolderPath | Pola w UserCache locked w UI |
| [ADR-005](../DECISIONS.md) Centralizacja routingu | Wpływa na `EmailRecipient` snapshot |
| [ADR-006](../DECISIONS.md) Hard delete pending | Definiuje cykl życia rekordu (pending może zniknąć, sent immutable) |

---

## Cross-reference

- Oryginalny PDF (baseline od architekta): [`../pdfs/BNC_fazaA_04_data_model.pdf`](../pdfs/BNC_fazaA_04_data_model.pdf)
