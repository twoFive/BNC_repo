...
Private Function ExpectedPublicProcs(moduleName As String) As Variant
    Select Case moduleName
        ...
        Case "mod_Tests"
            ExpectedPublicProcs = Array( _
                "RunAllTests", "Test_mod_Utils", "Test_IsFormOpen", _
                "Test_mod_AppStateSync", "Test_mod_DataCacheSync", _
                "Test_mod_Validation", "Test_mod_MailSender", _
                "Test_mod_Export", "Test_MultiUser")
        Case "mod_Diagnostic"
            ExpectedPublicProcs = Array( _
...
Private Function ExpectedFormControls(formName As String) As Variant
    Select Case formName
        ...
        Case "frm_Tutorial"
            ' v3.2: dodano img_ScreenshotMain + img_ScreenshotLog (2 Image controls
            ' na tej samej pozycji, visible per page przez RenderPage).
            ExpectedFormControls = Array( _
                "lbl_TutorialHeader", "lbl_PageIndicator", "lbl_PageTitle", _
                "txt_PageBody", "img_ScreenshotMain", "img_ScreenshotLog", _
